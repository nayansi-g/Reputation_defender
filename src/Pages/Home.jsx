  ...
  return (
    <div className="bg-blue-200">
      <div className=" min-h-screen ">
        <div className="absolute top-0 left-0 mt-28 w-full min-h-screen flex items-center justify-center bg-blue-200  text-black text-xl">
          <section className="text-black py-24 text-center">
            <motion.div
            ...
            >
              ...
              <div className="mt-8">
                <button className="bg-indigo-600 hover:bg-indigo-700 px-6 py-3 rounded-xl text-black font-semibold transition-transform duration-300 hover:scale-110">
                  Get Started
                </button>
              </div>
              <div className=" mt-20 flex items-center gap-20 justify-center">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <button className="bg-blue-200 rounded-full p-2 text-black font-bold transition-transform duration-300 hover:scale-110">
                    Book a Time
                  </button>
                </div>
              </div>
